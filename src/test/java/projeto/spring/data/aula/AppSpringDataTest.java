...
public class AppSpringDataTest {
	...
	public void testeInsert() {
		...
		usuarioSpringData.setNome("Flávio");
	...
	public void testeDeletePorNome() {
		interfaceSpringDataUser.deletePorNome("Flávio");
	}
	
	@Test
	public void testeUpdateEmailPorNome() {
		interfaceSpringDataUser.updateEmailPorNome("teste@gmail.com","Flávio");
	}
	...
	public void testeInsertTelefone() {
		...
		telefone.setNumero("2342-3333");
		telefone.setUsuarioSpringData(usuarioSpringData.get());
		interfaceTelefone.saveAtual(telefone);
		System.out.println("Telefone cadastrado -> " + interfaceSpringDataUser.count());
